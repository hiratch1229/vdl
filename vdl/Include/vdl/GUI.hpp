...
namespace vdl::GUI
{
  ...
  bool DragScalar(const char* _Label, DataType _Type, void* _pData, float _Speed, const void* _pMin = nullptr, const void* _pMax = nullptr, const char* _Format = nullptr, float _Power = 1.0f);
  bool DragScalarN(const char* _Label, DataType _Type, void* _pData, int _Components, float _Speed, const void* _pMin = nullptr, const void* _pMax = nullptr, const char* _Format = nullptr, float _Power = 1.0f);
  ...
  // - Adjust format string to decorate the value with a prefix, a suffix, or adapt the editing and display precision e.g. "%.3f" -> 1.234; "%5.2f secs" -> 01.23 secs; "Biscuit: %.0f" -> Biscuit: 1; etc.
  bool SliderScalar(const char* _Label, DataType _Type, void* _pData, const void* _pMin, const void* _pMax, const char* _Format = nullptr, float _Power = 1.0f);
  bool SliderScalarN(const char* _Label, DataType _Type, void* _pData, int _Components, const void* _pMin, const void* _pMax, const char* _Format = nullptr, float _Power = 1.0f);
  bool VSliderScalar(const char* _Label, const float2& _Size, DataType _Type, void* _pData, const void* _pMin, const void* _pMax, const char* _Format = nullptr, float _Power = 1.0f);
  ...
  template<class Type>
  inline bool VSlider(const char* _Label, const float2& _Size, Type* _pData, Type _Min, Type _Max, const char* _Format = Detail::GetDefaultFormat<Type>(), float _Power = 1.0f)
  {
    return VSliderScalar(_Label, _Size, Detail::GetDataType<Type>(), _pData, &_Min, &_Max, _Format, _Power);
  }
  ...
  bool InputScalar(const char* _Label, DataType _Type, void* _pData, const void* _pStep = nullptr, const void* _pStepFast = nullptr, const char* _Format = nullptr, const InputTextFlags& _Flags = InputTextFlag::eNone);
  bool InputScalarN(const char* _Label, DataType _Type, void* _pData, int _Components, const void* _pStep = nullptr, const void* _pStepFast = nullptr, const char* _Format = nullptr, const InputTextFlags& _Flags = InputTextFlag::eNone);
