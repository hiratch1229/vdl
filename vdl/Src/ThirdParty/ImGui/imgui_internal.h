...
namespace ImGui
{
    ...
    IMGUI_API bool          ImageButtonEx(ImGuiID id, const vdl::Texture& texture, const ImVec2& size, const ImVec2& uv0, const ImVec2& uv1, const ImVec2& padding, const ImVec4& bg_col, const ImVec4& tint_col);
