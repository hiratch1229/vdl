...
inline void WrapGraphicsCommandList::Initialize(vdl::InputLayoutType _InputLayout, vdl::TopologyType _Topology, vdl::BlendState&& _BlendState, vdl::DepthStencilState&& _DepthStencilState,
  vdl::RasterizerState&& _RasterizerState, vdl::Sampler&& _Sampler, vdl::VertexShader&& _VertexShader, vdl::PixelShader&& _PixelShader, InstanceBuffer&& _InstanceBuffer)
{
...
inline void WrapGraphicsCommandList::Reset()
{
  isReady_ = false;
...
inline void WrapGraphicsCommandList::SetVertexBuffer(const VertexBuffer& _VertexBuffer) { SetState(VertexBuffer) }

inline void WrapGraphicsCommandList::SetIndexBuffer(const IndexBuffer& _IndexBuffer) { SetState(IndexBuffer) }

inline void WrapGraphicsCommandList::SetInputLayout(vdl::InputLayoutType _InputLayout) { SetState(InputLayout) }

inline void WrapGraphicsCommandList::SetTopology(vdl::TopologyType _Topology) { SetState(Topology) }

inline void WrapGraphicsCommandList::SetScissor(const vdl::Scissor& _Scissor) { SetState(Scissor) }

inline void WrapGraphicsCommandList::SetViewport(const vdl::Viewport& _Viewport) { SetState(Viewport) }

inline void WrapGraphicsCommandList::SetBlendState(const vdl::BlendState& _BlendState) { SetState(BlendState) }

inline void WrapGraphicsCommandList::SetDepthStencilState(const vdl::DepthStencilState& _DepthStencilState) { SetState(DepthStencilState) }

inline void WrapGraphicsCommandList::SetRasterizerState(const vdl::RasterizerState& _RasterizerState) { SetState(RasterizerState) }

inline void WrapGraphicsCommandList::SetVertexShader(const vdl::VertexShader& _VertexShader) { SetState(VertexShader) }

inline void WrapGraphicsCommandList::SetHullShader(const vdl::HullShader& _HullShader) { SetState(HullShader) }

inline void WrapGraphicsCommandList::SetDomainShader(const vdl::DomainShader& _DomainShader) { SetState(DomainShader) }

inline void WrapGraphicsCommandList::SetGeometryShader(const vdl::GeometryShader& _GeometryShader) { SetState(GeometryShader) }

inline void WrapGraphicsCommandList::SetPixelShader(const vdl::PixelShader& _PixelShader) { SetState(PixelShader) }
#undef SetState
...
template<ShaderType Type>
inline void WrapGraphicsCommandList::SetShaderResources(vdl::uint _StartSlot, vdl::uint _ShaderResourceNum, const vdl::ShaderResource _ShaderResources[]) { SetShaderState(ShaderResource) }

template<ShaderType Type>
inline void WrapGraphicsCommandList::SetSamplers(vdl::uint _StartSlot, vdl::uint _SamplerNum, const vdl::Sampler _Samplers[]) { SetShaderState(Sampler) }

template<ShaderType Type>
inline void WrapGraphicsCommandList::SetConstantBuffers(vdl::uint _StartSlot, vdl::uint _ConstantBufferNum, const vdl::Detail::ConstantBufferData _ConstantBuffers[]) { SetShaderState(ConstantBuffer) }
  ...
  vdl::RasterizerState&& _RasterizerState, vdl::Sampler&& _Sampler, vdl::VertexShader&& _VertexShader, vdl::PixelShader&& _PixelShader, InstanceBuffer&& _InstanceBuffer)
{
  ...
  WrapGraphicsCommandList::Initialize(_InputLayout, _Topology, std::move(_BlendState), std::move(_DepthStencilState), std::move(_RasterizerState), std::move(_Sampler), std::move(_VertexShader), std::move(_PixelShader), std::move(_InstanceBuffer));
}
...
inline void GraphicsCommandList<DisplayObject, InstanceData>::SetDrawData(const DisplayObject& _DisplayObject, InstanceData&& _InstanceData)
{
  ...
  //  必要ステートの設定
  {
    WrapGraphicsCommandList::SetVertexBuffer(pMesh->VertexBuffer);
    WrapGraphicsCommandList::SetIndexBuffer(pMesh->IndexBuffer);

    vdl::ShaderResource ShaderResources[2] = { pMesh->Material.Diffuse, pMesh->Material.NormalMap };
    WrapGraphicsCommandList::SetShaderResources<ShaderType::ePixelShader>(0, 2, ShaderResources);
  }
  ...
  //  現在のステートのコマンドを発行
  WrapGraphicsCommandList::PushGraphicsCommand();
...
{
  WrapGraphicsCommandList::Initialize(_InputLayout, _Topology, std::move(_BlendState), std::move(_DepthStencilState), std::move(_RasterizerState), std::move(_Sampler), std::move(_VertexShader), std::move(_PixelShader), InstanceBuffer());
}
...
{
  WrapGraphicsCommandList::Initialize(_InputLayout, _Topology, std::move(_BlendState), std::move(_DepthStencilState), std::move(_RasterizerState), std::move(_Sampler), vdl::VertexShader(), vdl::PixelShader(), InstanceBuffer());
}
